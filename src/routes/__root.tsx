...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "myShareek — Where founders, talent and investors meet" },
      { name: "description", content: "myShareek connects entrepreneurs, skilled professionals and investors to build and back the next generation of startups." },
      { property: "og:title", content: "myShareek — Where founders, talent and investors meet" },
      { property: "og:description", content: "myShareek connects entrepreneurs, skilled professionals and investors to build and back the next generation of startups." },
